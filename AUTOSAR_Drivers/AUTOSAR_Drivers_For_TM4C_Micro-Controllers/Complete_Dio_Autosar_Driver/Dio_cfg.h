...
/* Ports Index in the array of structures in Dio_PBcfg.c */
#define DioConf_PORTF_INDEX                  (uint8)0x00
   
/* DIO Configured Port */
#define DioConf_PORTF_NUM                    (Dio_PortType)5 /* PORTF */ 
...
/* Channel Index in the array of structures in Dio_PBcfg.c */
#define DioConf_GROUP1_INDEX                (uint8)0x00   
   
/* DIO Configured Groups */
#define DioConf_GROUP1_PORT_NUM             (Dio_PortType)5 /* PORTF */ 
#define DioConf_GROUP1_MASK                 (uint8)0x01F
#define DioConf_GROUP1_OFFSET               (uint8)0  
