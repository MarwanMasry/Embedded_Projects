 ...
 * Module: OS
 *
 * File Name: OS_Registers.h
 *
 * Description: Header file for TM4C123GH6PM Microcontroller - OS Driver Registers
 *
 * Author: Marwan Abdelhakim Elmasry
 ******************************************************************************/
#ifndef OS_REGISTERS_H_
#define OS_REGISTERS_H_
