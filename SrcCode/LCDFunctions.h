...
void LCD_Init(void){
	...
	/*
	here we want to initiallize all the pins in Port B  and PA5 PA6 PA7 In port A  we use port B for the data and A for command for LCD
	 PA5 is the Rs(register selector) , PA6 is RW and PA7 E. we make all these Pins GPIO , Digtal , Output and enable change to
...
void LCD_Command(unsigned char command){
	GPIO_PORTA_DATA_R &= ~0xE0;    //set RS=0, Rw=0 , E=0 to enable writing to command register in LCD
...
void LCD_Display_Restart(void){
	...
	int i;
	char *string1="Do You Want to";
	char *string2="Restart?  Y/N";
